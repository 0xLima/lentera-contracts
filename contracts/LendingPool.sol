 ...
 * @dev Main point of interaction with the Lentera protocol's market
 * - Users can:
    ...
    Pausable
{
    ...
    /// @dev for convienency this address is used to represent BNB just like BEP20
    ...
    /// @dev the principalAmount_ parameter is use for BEP20 tokens only
